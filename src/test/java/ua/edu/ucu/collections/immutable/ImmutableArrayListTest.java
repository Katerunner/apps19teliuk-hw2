...
public class ImmutableArrayListTest {
    private ImmutableArrayList small;
    private Object[] addon;
    private ImmutableArrayList big;
    private ImmutableArrayList noElements;

    @Before
    public void setUp() throws Exception {
        small = new ImmutableArrayList(new Object[]{7, 2, 9, 5});
        big = new ImmutableArrayList(new Object[]{12, 3, 5, 7, 65, 4, 645, 7, 56, 33, 6});
        noElements = new ImmutableArrayList();
    ...
    public void testRemove() {
        Object[] actual = big.remove(0).toArray();
